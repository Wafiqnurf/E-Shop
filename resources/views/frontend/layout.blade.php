            ...
            <div class="container-fluid">
                <div class="header-bottom-wrapper">
                    <div class="logo-2 furniture-logo ptb-30">
                        <a href="/">
                            <img src="{{ asset('themes/ezone/assets/img/logo/3.png') }}"
                                style="widht:125px;height:100px" alt="">
                        </a>
                    </div>
            ...
            <div class="container-fluid">
                <div class="widget-wrapper">
                    <div class="footer-widget mb-30">
                        <a href="#"><img src="{{ asset('themes/ezone/assets/img/logo/1.png') }}"
                                style="widht:250px; height:150px" alt=""></a>
